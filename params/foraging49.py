...
robot_personality_list = [13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13, 13]
perception_range = 3
battery_size = 50
heading_size = 8
...
results_filename = "results/foraging49.npz"
plot_label = "Model 1"
human_description = "25x25, heading 1, heading 3 (map b), 12 bots, per range 3, no local"
