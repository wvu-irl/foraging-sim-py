...
robot_personality_list = [13, 13, 13, 13]
perception_range = 2
battery_size = 50
heading_size = 8
...
results_filename = "results/foraging20.npz"
plot_label = "Model 2"
human_description = "25x25, heading 1, heading 5 (map c), 4 bots, per range 2, no local"
